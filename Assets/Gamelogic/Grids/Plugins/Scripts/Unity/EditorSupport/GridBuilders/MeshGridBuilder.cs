...
namespace Gamelogic.Grids
{
	...
	/// </summary>
	/// <typeparam name="TPoint">The type of point of the grid that this builder is building.</typeparam>
	[Experimental]
	[Version(1, 14)]
		...
		where TPoint : IGridPoint<TPoint>
	{
		...
		protected Color[] colors = Utils.DefaultColors;
		...
		private void SetupGrid()
		{
			...
			if (gridBehaviour == null)
			{
				...
				grid.Fill((p) => new MeshCell(GetColorFunc(19, 1, 1)(p)));
			}
			else
			{
			...
			int textureIndex)
		{
			...
			int textureIndexY = textureIndex / textureWidth;
